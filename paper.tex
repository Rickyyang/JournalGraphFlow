...
Reachability analysis is a common step in the security and safety verification synthesis for cyber-physical systems (CPSs) \cite{gueguen2009safety,ding2020secure}. A common method is to compute an over-approximation of the reachable space for checking safety properities. Various researches rely on a geometrical extrapolation of the system states like zonotopes and ellipsoids as representation of a compact enclosure of the reachability sets \cite{kurzhanski2000ellipsoidal,lakhal2019interval,maiga2015comprehensive,maiga2015comprehensive}. The work in \cite{}
