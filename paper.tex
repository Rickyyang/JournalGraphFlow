...
Within each sub-team, at least one robot is required to follow the reference trajectory to fulfill the required tasks. Meanwhile, the additional robots can switch from one reference trajectory to another in order to perform co-observation with different sub-teams. \rtron{$\star$}\rtron{Give a little more details about how cross-trajectory co-observations are defined to ensure safety.}
