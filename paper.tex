...
\begin{figure}
  \centering
  \subfloat[Map exploration task\label{fig:illustration}]{\includegraphics[width = 0.45\linewidth,, trim = 0.3cm 1.3cm 0.3cm 2cm,valign=c]{illustration figure_1}} 
...
\begin{figure}
  \centering
  \subfloat[Grid world result\label{fig:Grid-example-application}]{\includegraphics[height = 0.47\linewidth,trim =0cm 0cm 0cm 0cm, clip,valign=t]{Grid_world}}
