...
As required by the security guarantee in \Cref{rmk:revised-security}, reference robots must be seen by at least one cross-reference robot at every checkpoint.
