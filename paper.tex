...
\rtron{Define $\varPhi$ and $\Omega$ in words but briefly}
...
\zyang{plot new simpler example, add collision avoidance}
 ...
 \rtron{Move to right after the definition of differential}
...
\rtron{Extend the figure to give a graphical representation of the canonical transformation}
